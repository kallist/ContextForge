...
for (const name of ['repobound-hero.png','repobound-context.png','repobound-why.png','repobound-flow.svg','social-card.png']) await copyFile('docs/assets/'+name,'.studio-output/site/assets/'+name);
