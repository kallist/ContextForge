...
test("three benchmark systems are deterministic, hard-budgeted, fair at the ranking boundary, and Gold-blind", async (context) => {
  ...
  assert.ok(structural !== undefined && contextforge !== undefined);
