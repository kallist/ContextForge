...
export const REVIEW_HELP = "\nReview Context: repobound review [repository] [--base HEAD] [--budget 8000] [--refresh-index] [--json] [--capsule file.json] [--out context.md]\nCompares a resolved base to the tracked working tree. Stage new files first.\n";
export async function runReview(argv: readonly string[], cwd: string): Promise<number | null> {
  ...
  catch { throw new ContextForgeError("USAGE", "Invalid review options. Run repobound review --help."); }
